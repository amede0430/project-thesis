    ...
    <div className="min-h-screen bg-light-secondary">
      ...
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">Carte du Réseau</h1>
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-sm text-gray-900 focus:border-aqua-primary focus:outline-none focus:ring-1 focus:ring-aqua-primary"
              />
            </div>
            <select
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
          <div className="relative w-full h-[700px] rounded-sm overflow-hidden">
            ...
            {/* Status info */}
            <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm p-3 rounded-lg text-sm z-[1000] border border-gray-200 shadow-md">
              <div className="font-semibold text-gray-900 mb-1">Réseau AquaGuard</div>
            ...
            {/* Quick stats */}
            <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm p-3 rounded-lg text-xs z-[1000] border border-gray-200 shadow-md">
              <div className="grid grid-cols-2 gap-3">
                <div className="text-center">
                  <div className="text-red-600 font-bold text-lg">{sensorCounts.inactive}</div>
                  <div className="text-gray-700">Inactifs</div>
                </div>
                <div className="text-center">
                  <div className="text-orange-600 font-bold text-lg">{sensorCounts.error}</div>
                  <div className="text-gray-700">Erreurs</div>
                </div>
                <div className="text-center">
                  <div className="text-yellow-600 font-bold text-lg">{sensorCounts.maintenance}</div>
                  <div className="text-gray-700">Maintenance</div>
                </div>
                <div className="text-center">
                  <div className="text-green-600 font-bold text-lg">{sensorCounts.active}</div>
